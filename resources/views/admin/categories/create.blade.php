<x-layouts.admin>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="p-4 lg:p-6 space-y-5">
                @csrf
                ...
                <!-- Icon Selector -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-3">Select Category Icon *</label>
                    <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
                        @php
                            $icons = [
                                'motorcycle' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/>',
                                ...
                                'droplet' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 2C12 2 8 6 8 10c0 2.21 1.79 4 4 4s4-1.79 4-4c0-4-4-8-4-8zm0 10c-1.1 0-2-.9-2-2 0-1.5 2-4 2-4s2 2.5 2 4c0 1.1-.9 2-2 2z"/>',
                        ...
                        <label class="icon-option cursor-pointer">
                            <input type="radio" name="icon" value="{{ $iconName }}" class="hidden peer" {{ old('icon') == $iconName ? 'checked' : '' }} required>
                            <div class="w-12 h-12 rounded-xl border-2 border-gray-200 flex items-center justify-center transition-all peer-checked:border-red-500 peer-checked:bg-red-50 hover:border-gray-300 hover:bg-gray-50">
                                <svg class="w-6 h-6 text-gray-600 peer-checked:text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    {!! $iconPath !!}
                                </svg>
                            </div>
                        </label>
    ...
    <style>
        .icon-option input:checked + div {
            border-color: #dc2626;
            background-color: #fef2f2;
        }
        .icon-option input:checked + div svg {
            color: #dc2626;
        }
    </style>
</x-layouts.admin>
