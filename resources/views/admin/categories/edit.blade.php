<x-layouts.admin>
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-xl shadow-sm overflow-hidden">
            ...
            <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="p-4 lg:p-6 space-y-5">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-2">
                        ...
                        <label class="icon-option cursor-pointer">
                            <input type="radio" name="icon" value="{{ $iconName }}" class="hidden peer" {{ $currentIcon == $iconName ? 'checked' : '' }} required>
